 ...
 */
public abstract class Hilt_CategoryDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CategoryDetailsFragment() {
    super();
  }

  Hilt_CategoryDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CategoryDetailsFragment_GeneratedInjector) this.generatedComponent()).injectCategoryDetailsFragment(UnsafeCasts.<CategoryDetailsFragment>unsafeCast(this));
    }
  }
