 ...
 */
public abstract class Hilt_SearchCategoryFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchCategoryFragment() {
    super();
  }

  Hilt_SearchCategoryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchCategoryFragment_GeneratedInjector) this.generatedComponent()).injectSearchCategoryFragment(UnsafeCasts.<SearchCategoryFragment>unsafeCast(this));
    }
  }
